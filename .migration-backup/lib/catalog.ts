...
import { getCatalogObjectKey, getTextObject, isR2Configured, putTextObject } from "@/lib/r2";
import type { BookRecord, Catalog, ChapterRecord, UploadPayload } from "@/lib/types";
import { chapterTitleFromFilename, makeId, normalizeText, slugify } from "@/lib/utils";
...
export async function appendChapters(records: ChapterRecord[], payload: UploadPayload) {
